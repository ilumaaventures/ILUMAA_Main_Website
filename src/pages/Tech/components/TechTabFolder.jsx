              ...
              {techTracks.map((track, idx) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative flex shrink-0 items-center gap-2.5 rounded-2xl border px-4 py-3 text-left transition-all duration-200 sm:px-5 sm:py-3.5 ${
                      isActive
                        ? "border-blue-500/40 bg-white shadow-[0_8px_24px_rgba(37,99,235,0.12)] ring-2 ring-blue-500/20"
                        : "border-slate-200/90 bg-slate-50/90 hover:border-slate-300 hover:bg-white text-slate-600 hover:text-slate-900"
                    }`}
                  >
                    ...
                    <div className="relative z-10 flex items-center gap-2.5">
                      ...
                      <span
                        className={`font-heading text-xs font-bold leading-tight sm:text-[13px] ${
