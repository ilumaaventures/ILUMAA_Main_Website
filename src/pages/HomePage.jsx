  ...
  return (
    <>
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#070e1b] px-4 py-20 text-center sm:px-8 lg:px-12">
        ...
        >
          <h1 className="mx-auto max-w-4xl font-heading text-[2.35rem] font-semibold leading-[1.08] text-white drop-shadow-[0_4px_16px_rgba(0,0,0,0.85)] sm:text-[2.85rem] lg:text-[3.65rem]">
