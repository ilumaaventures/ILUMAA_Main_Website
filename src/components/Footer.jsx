  ...
  return (
    <footer
      className={`relative z-10 border-t ${
        isTechnologyPage
          ? "border-slate-400/30 bg-[#CBCED3] text-slate-900"
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.8fr_0.8fr_0.72fr]">
          <div>
            <img src={logoSrc} alt="ILUMAA" className="h-16 w-auto sm:h-20" />
            <p
              className={`mt-5 max-w-sm text-sm leading-8 ${
                isTechnologyPage ? "text-slate-700" : "text-slate-600"
              }`}
            >
              ...
              {chips.map((chip) => (
                <span
                  ...
                  className={`rounded-full border px-3 py-2 text-[11px] uppercase tracking-[0.16em] ${
                    isTechnologyPage
                      ? "border-slate-400/40 bg-slate-300/60 text-slate-800"
            ...
            <p
              className={`mt-6 text-sm leading-8 ${
                isTechnologyPage ? "text-slate-700" : "text-slate-500"
              }`}
            >
          ...
          <div>
            <h3
              className={`font-heading text-lg font-bold ${
                isTechnologyPage ? "text-slate-950" : "text-slate-950"
              }`}
            >
              Quick Links
            </h3>
          ...
          <div>
            ...
            <div
              className={`mt-5 space-y-4 text-sm ${
                isTechnologyPage ? "text-slate-700 font-medium" : "text-slate-600"
              }`}
            >
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-4">
              <a className={`inline-flex items-center gap-3 text-sm uppercase tracking-[0.14em] transition ${
                isTechnologyPage ? "text-slate-700 hover:text-slate-950 font-medium" : "text-slate-600 hover:text-slate-950"
              }`}>
        ...
        <div
          className={`mt-12 border-t pt-6 text-sm ${
            isTechnologyPage
              ? "border-slate-400/30 text-slate-700"
